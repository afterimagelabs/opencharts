        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-7">
            ...
            <p className="mt-10 text-lg lg:text-xl text-ink-soft max-w-prose leading-relaxed">
              ...
              receive a copy of their own medical records within 30 days of asking. When providers
              stall — and they often do — what holds them accountable is a clean, dated record of
              every step. OpenCharts helps you build one.
            </p>
  ...
  return (
    ...
    >
      <defs>
        ...
        <path id="curve-bot" d="M 50 200 A 150 150 0 0 0 350 200" />
      </defs>
      ...
      <text className="fill-seal" style={{ fontSize: 11, letterSpacing: '0.4em', fontWeight: 500 }}>
        <textPath href="#curve-bot" startOffset="50%" textAnchor="middle">
          PATIENT ACCESS · PUBLIC INTEREST
        </textPath>
      </text>
    </svg>
  );
